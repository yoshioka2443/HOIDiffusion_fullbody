...
def render_skeleton(obj_file_path, sbj_file_path, root_dir, object_name):
    ...
    output_path = object_name + "_skeleton.png"
...
def generate_depth_and_mask(obj_file_path, sbj_file_path, root_dir, object_name, output_size=(512, 512)):
    # Load meshes
    obj_mesh = trimesh.load(obj_file_path)
    sbj_mesh = trimesh.load(sbj_file_path)
    ...
    cv2.imwrite(os.path.join(root_dir, object_name + "_depth.png"), depth_image)
    cv2.imwrite(os.path.join(root_dir, object_name + "_seg.png"), mask)
    cv2.imwrite(os.path.join(root_dir, object_name + "_mask.png"), segmentation)
...
def main():
    ...
    root_dir = "/home/datasets/fullbody_test_goal_croped"
    ...
    object_name = obj_file_path.split("/")[-2]

    generate_depth_and_mask(obj_file_path, sbj_file_path, root_dir, object_name)
    render_skeleton(obj_file_path, sbj_file_path, root_dir, object_name)
