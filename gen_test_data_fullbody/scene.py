...
def plot_mesh(vertices, obj_vertices, sbj_vertices, camera_position):
...
def setup_smplx_scene(joints_file_path, verts_file_path, obj_file_path, sbj_file_path):
    ...
    # add obj
    # Plot the mesh
    plot_mesh(vertices, obj_mesh.vertices, sbj_mesh.vertices, camera_position)
...
def main():
    ...
    sbj_file_path = "/home/datasets/GOAL/results/MNet_terminal/static_and_motion_1/s10_apple_eat_1_motion_meshes/0050_sbj.ply"
    obj_file_path = "/home/datasets/GOAL/results/MNet_terminal/static_and_motion_1/s10_apple_eat_1_motion_meshes/0050_obj.ply"
    ...
    # Run the function
    setup_smplx_scene(joints_file_path, verts_file_path, obj_file_path, sbj_file_path)
