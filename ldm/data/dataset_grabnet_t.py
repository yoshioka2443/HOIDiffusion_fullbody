...
class dataset_grabnet():
    def __init__(self, path_json):
        ...
        with open(path_json, 'r', encoding='utf-8') as fp:
            ...
            for file in data:
                ...
                self.files.append({'rgb': file["image"], "skeleton":file["skeleton"], "mask": file["mask"], "sentence":file["sentence"], "seg":file["seg"], "texture":file["texture"], "shape":{"top":file["top"],"bottom":file["bottom"],"left":file["left"],"right":file["right"]}})
    ...
    def __getitem__(self, idx):
        ...
        return {'im': im, 'depth': depth, 'skeleton':skeleton, 'sentence': sentence, "seg": seg, "mask": mask, 'shape':file["shape"], "name":name, "texture":texture}
